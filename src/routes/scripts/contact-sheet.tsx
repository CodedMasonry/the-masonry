...
export const Route = createFileRoute("/scripts/contact-sheet")({
  component: ContactSheetCreatorPage,
})
...
export default function ContactSheetCreatorPage() {
  return (
      ...
      <div className="container mx-auto max-w-4xl px-4 py-12">
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-balance text-muted-foreground">
            Generate a beautiful 4×3 contact sheet from up to 12 images
          </p>
        </div>
...
function ContactSheetCreator() {
  ...
  return (
    <div className="space-y-6">
      <Card className="border-2 border-dashed border-border p-6">
