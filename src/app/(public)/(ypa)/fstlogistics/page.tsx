...
function Header() {
  return (
    <div className="mx-8 mt-16 flex flex-col space-y-1">
      <h1 className="text-4xl font-semibold underline decoration-primary">
      ...
      <div className="mx-8 mt-8 flex flex-col md:flex-row">
        <div>
          <p className="max-w-4xl">
            ...
            mentorship program. I interned at a company called FST Logistics; a
          ...
          <p className="mt-8 max-w-4xl">
            The focus of my mentorship was to improve on my soft skills, as I
        ...
        <div className="mx-auto mt-8 min-w-72 md:ml-16 md:mt-0 md:min-w-96">
          <Image
      ...
      <div className="mx-8 mt-8 flex flex-col md:flex-row">
        <div>
          ...
          <p className="mt-8 max-w-6xl">
            The mentorship helped me realize I am on the right path, but I want
            ...
            mentorship centered around a larger development team where I can see
