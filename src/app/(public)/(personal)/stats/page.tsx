    ...
    <>
      <div className="mt-12 mr-4 ml-8 flex flex-col space-y-2 md:mt-32 md:ml-36">
        ...
        <h2 className="my-2 text-3xl underline decoration-primary drop-shadow-lg">
          Me? I'm just trying to get college apps done so I can go back to
          focusing on code.
        </h2>
        <p className="pt-1 drop-shadow-lg md:max-w-3xl">
          I will turn this page into a blog when I have time. I hope you have a
          great rest of your day. (if you're in YPA, tell Mr. Mousa I said hi)
        </p>
      </div>
    </>
  );
