...
function Header() {
	return (
		<div className="mx-8 mt-16 flex flex-col space-y-1">
			<h1 className="font-bold text-4xl underline decoration-primary">
...
function SkillOne() {
	return (
		<div className="mx-8 mt-8 flex flex-col">
			<h3 className="font-semibold text-3xl text-green-600">1) Analytical</h3>
...
function SkillTwo() {
	return (
		<div className="mx-8 mt-8 flex flex-col">
			<h3 className="font-semibold text-3xl text-purple-600">2) Arranger</h3>
			<p className="max-w-4xl">
...
function SkillThree() {
	return (
		<div className="mx-8 mt-8 flex flex-col">
			<h3 className="font-semibold text-3xl text-purple-600">3) Restorative</h3>
			<p className="max-w-4xl">
...
function SkillFour() {
	return (
		<div className="mx-8 mt-8 flex flex-col">
			<h3 className="font-semibold text-3xl text-blue-600">4) Developer</h3>
			<p className="max-w-4xl">
...
function SkillFive() {
	return (
		<div className="mx-8 mt-8 flex flex-col">
			<h3 className="font-semibold text-3xl text-green-600">5) Futuristic</h3>
			<p className="max-w-4xl">
