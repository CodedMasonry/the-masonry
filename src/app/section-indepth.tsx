...
export default function SectionInDepth() {
  const [leftHovered, setLeftHovered] = useState(true);
...
function GridItem({
  ...
  return (
    <Link
      href={href}
      className="mt-4 flex flex-row rounded-xl border-2 border-transparent p-4 drop-shadow-lg transition-all hover:-translate-y-2 hover:border-primary"
    >
      <Image
        src={image}
        width={112}
        height={112}
        alt=""
        className="aspect-square size-28 my-auto"
      />
      <div className="ml-4 flex flex-col items-start border-l-2 border-foreground pl-4 align-middle">
